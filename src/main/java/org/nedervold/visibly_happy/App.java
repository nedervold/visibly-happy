...
public class App {
	public static void main(final String[] args) {
		SwingUtilities.invokeLater(() -> {
			...
			final Stream<String> sourceStream = happyWindow.runOutputStream.map(HappySource::getSource);
			...
			final HappySourceWindow sourceWindow = new HappySourceWindow("Happy source",
					Operational.updates(happyWindow.happySourceCell.map(HappySource::getSource)));
